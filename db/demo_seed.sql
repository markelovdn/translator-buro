...
('Иван Петров', 'ivan@example.com', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
('Анна Смирнова', 'anna@example.com', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
('Олег Кузнецов', 'oleg@example.com', 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
...
SELECT t.id, d.day_of_week, 1, UNIX_TIMESTAMP()
FROM translator t
